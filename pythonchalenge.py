...
-"""
for a in i:
    if i[i.index(a)-3].isupper() and i[i.index(a)-2].isupper() and i[i.index(a)-1].isupper() and a.islower() and i[i.index(a)+1].isupper() and i[i.index(a)+2].isupper() and i[i.index(a)+3].isupper():
        print (i[i.index(a)-3]+i[i.index(a)-2]+i[i.index(a)-1]+a+i[i.index(a)+1]+i[i.index(a)+2]+i[i.index(a)+3])
konec=input('exit')
if konec==True:
    raise SystemExit
